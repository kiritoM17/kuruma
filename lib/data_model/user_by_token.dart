...
class UserByTokenResponse {
  ...
  factory UserByTokenResponse.fromJson(Map<String, dynamic> json) => UserByTokenResponse(
    ...
    avatar: json["avatar"] == null ? null : AppConfig.RAW_BASE_URL + '/public/' + json["avatar"],
    avatar_original: json["avatar_original"] == null ? null : AppConfig.RAW_BASE_URL + '/public/' + json["avatar_original"],
