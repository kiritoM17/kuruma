...
class DetailedProduct {
  ...
  factory DetailedProduct.fromJson(Map<String, dynamic> json) => DetailedProduct(
    ...
    shop_logo: AppConfig.RAW_BASE_URL + '/public/' + json["shop_logo"],
    photos: List<Photo>.from(json["photos"].map((x) => Photo.fromJson(x))),
    thumbnail_image: AppConfig.RAW_BASE_URL + '/public/' + json["thumbnail_image"],
...
class Brand {
  ...
  factory Brand.fromJson(Map<String, dynamic> json) => Brand(
    id: json["id"],
    name: json["name"],
    logo: AppConfig.RAW_BASE_URL + '/public/' + json["logo"],
  );
