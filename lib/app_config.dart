...
class AppConfig {
  ...
  static String purchase_code = "54813500-7ef0-4481-a230-941277f072a4"; //enter your purchase code for the app from codecanyon
  ...
  static const DOMAIN_PATH = "kuruba.cm"; // directly inside the public folder
